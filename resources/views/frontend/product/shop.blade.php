                ...
                <div class="col-md-9 col-md-push-3">
                					<div class="row row-pb-lg">
                                        @foreach($room as $item)
                                               ...
                                               <div class="card mb-3 " style="max-width: 100%; border: 1px solid #d9d7d7 ; padding: 5% ;border-radius:10px ">
                                                   <div class="row g-0">
                                                       <div class="col-md-4">
                                                           <img src="{{$item->hinh_anh ? Storage::url($item->hinh_anh):""}}"
                                                                class="img-fluid rounded-start" alt="..." width="100%"
                                                                style="border-radius: 5px">
                                                       </div>
                                                       <div class="col-md-8">
                                                           <div class="card-body">
                                                               <h3 class="card-title" >{{$item->ten_phong}}</h3>
                                                               <p class="card-text">
                                                                   {{$item->mo_ta}}
                                                               </p>
                                                               <p class="card-text" style="font-size: 2rem;color:red;">
                                                                   <span style="margin-right: 20px"><u>đ</u> <s>{{number_format($item->gia_phong)  }} </s></span>
                                                                   <u>đ</u>   {{ number_format($item->giam_gia)}}
                                                               </p>
                                                           </div>
                                                         <a href="{{route('shopdetail',['id'=>$item->id])}}">  <button class="btn btn-primary" style="float: right">Đặt Phòng</button></a>
                                                       </div>
                                                   </div>
