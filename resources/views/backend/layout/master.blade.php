...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span>QuangVLOG&N </span>Admin</a>
            <ul class="user-menu">
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li><a href="order.html">
                ...
                Đơn hàng</a></li>
        <li><a href="{{route('banner')}}">
                <svg class="glyph stroked notepad ">
                    <use xlink:href="#stroked-notepad"/>
                </svg>
                Banner</a></li>
        <li role="presentation" class="divider"></li>
        <li><a href="listuser.html">
                <svg class="glyph stroked male-user">
                    <use xlink:href="#stroked-male-user"></use>
                </svg>
			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu"><li><a href="#"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> {{ Auth::user()->email }}</a></li>
...
>>>>>>> b089bb1f57f9da829e8c0be535228fc0f1b50018
